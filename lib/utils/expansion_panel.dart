// Copyright 2014 The Flutter Authors & The Boatman Contributors. All rights reserved.
// Original: Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.
// By the including in boatman, it will follow boatman's LICENSE.

import 'package:flutter/widgets.dart';

// Rubicon: I don't know why `ExpansionPanel` does not provide an option for trailing icons...
// ...so I copy and edit the file for the purpose.
...
class ExpansionPanelList extends StatefulWidget {
  ...
  /// Tell if should automatically add a arrow as trailing button.
  final bool autoTrailingButton;
    ...
    for (int index = 0; index < widget.children.length; index += 1) {
      ...
      Widget header = Row(
        children: <Widget>[
          ...
          if (widget.autoTrailingButton) expandIconContainer,
        ],
      );
      if (child.canTapOnHeader) {
